...
namespace SalesPlanningMonitorng.Controllers
{
    public class BarangController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="id_barang,nama_barang,harga,kategori")] Barang barang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="id_barang,nama_barang,harga,kategori")] Barang barang)
        {
            if (ModelState.IsValid)
            {
